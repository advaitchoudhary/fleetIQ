...
router.get("/report", protect, authorizeRoles(...ALL_ADMIN), requireGrowth, generateReport);
router.get("/report/pdf", protect, authorizeRoles(...ALL_ADMIN), requireGrowth, downloadPDF);
