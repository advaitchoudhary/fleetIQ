...
const styles: Record<string, React.CSSProperties> = {
  ...
  secondaryBtn: { display: "flex", alignItems: "center", gap: "8px", background: "var(--t-hover-bg)", color: "var(--t-text-secondary)", border: "1px solid var(--t-border-strong)", borderRadius: "10px", cursor: "pointer", padding: "10px 18px", fontSize: "13px", fontWeight: 600, fontFamily: "Inter, system-ui, sans-serif" },
