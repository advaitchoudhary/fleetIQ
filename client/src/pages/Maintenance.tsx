...
import { FaPlus, FaEdit, FaTrashAlt, FaSearch, FaBell } from "react-icons/fa";
  ...
  return (
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: "var(--t-bg)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1300px", margin: "0 auto", padding: "32px 40px" }}>
        ...
        {/* Breadcrumb */}
        <div style={{ fontSize: "11px", fontWeight: 700, color: "var(--t-text-faint)", letterSpacing: "1px", marginBottom: "14px" }}>MAINTENANCE</div>
