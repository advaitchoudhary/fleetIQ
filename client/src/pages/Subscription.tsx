...
const PLANS = [
  {
    ...
    monthlyPrice: "$49",
    annualPrice: "$39",
    description: "Everything you need to manage your drivers.",
    features: [
      "Unlimited drivers",
  ...
  },
  {
    ...
    monthlyPrice: "$49",
    annualPrice: "$39",
    description: "Full Fleetio-style vehicle management.",
    features: [
      "Vehicle registry",
      "Maintenance scheduling",
      "DVIR inspections",
      "Fuel logging & L/100km stats",
  ...
  },
  {
    ...
    monthlyPrice: "$79",
    annualPrice: "$63",
    description: "Complete fleet + driver management in one.",
    badge: "Best Value",
    features: [
